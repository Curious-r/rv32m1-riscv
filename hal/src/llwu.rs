...
pub struct Llwu {
    regs: &'static pac::llwu0::RegisterBlock,
}

impl Llwu {
    pub fn new() -> Self {
        let regs = unsafe { &*(pac::Llwu0::ptr() as *const pac::llwu0::RegisterBlock) };
        Self { regs }
    }

    pub fn new_llwu1() -> Self {
        let regs = unsafe { &*(pac::Llwu1::ptr() as *const pac::llwu0::RegisterBlock) };
        Self { regs }
    }
