...
pub fn enable_lpspi_clock(pcc: &pac::Pcc0, instance: u8) {
    match instance {
        0 => { pcc.pcc_lpspi0().write(|w| w.cgc().cgc_1()); }
        1 => { pcc.pcc_lpspi1().write(|w| w.cgc().cgc_1()); }
        2 => { pcc.pcc_lpspi2().write(|w| w.cgc().cgc_1()); }
        _ => {}
    }
}
...
pub fn enable_lpi2c_clock(pcc: &pac::Pcc0, instance: u8) {
    match instance {
        0 => { pcc.pcc_lpi2c0().write(|w| w.cgc().cgc_1()); }
        1 => { pcc.pcc_lpi2c1().write(|w| w.cgc().cgc_1()); }
        2 => { pcc.pcc_lpi2c2().write(|w| w.cgc().cgc_1()); }
        _ => {}
    }
}

pub fn enable_lpit0_clock(pcc: &pac::Pcc0) {
    pcc.pcc_lpit0().write(|w| w.cgc().cgc_1());
}

pub fn enable_lpuart_clock(pcc: &pac::Pcc0, instance: u8) {
    match instance {
        0 => { pcc.pcc_lpuart0().write(|w| w.cgc().cgc_1()); }
        1 => { pcc.pcc_lpuart1().write(|w| w.cgc().cgc_1()); }
        2 => { pcc.pcc_lpuart2().write(|w| w.cgc().cgc_1()); }
        _ => {}
    }
}
